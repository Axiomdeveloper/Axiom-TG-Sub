...
export default function ChannelBoard({ channels, synced }: { channels: ChannelStat[]; synced: boolean }) {
  ...
  return (
    <section id="channels" className="relative z-10 mx-auto w-full max-w-6xl px-4 py-24 md:px-6">
      <SectionHeading
      ...
      {!synced || sorted.length === 0 ? (
        <Reveal>
          <div className="glass g-border card relative overflow-hidden rounded-3xl p-10 text-center">
            <div className="mx-auto mb-6 grid h-16 w-16 place-items-center rounded-3xl border border-mint/25 bg-mint/5 text-mint">
              <Satellite size={28} />
            </div>
        ...
        <div className="glass g-border card overflow-hidden rounded-3xl">
          <div className="flex items-center justify-between border-b hairline px-6 py-4 text-[11px] text-zinc-500">
                ...
                <Reveal delay={i * 60}>
                  <div className="group flex items-center gap-4 px-6 py-4 transition-colors hover:bg-white/[0.02]">
                    ...
                    <a
                      ...
                      rel="noreferrer"
                      dir="ltr"
                      className="mono flex min-w-0 items-center gap-1.5 font-mono text-sm text-zinc-100 transition-colors group-hover:text-mint"
                    >
                      <span className="truncate">@{c.id}</span>
                      <ExternalLink size={12} className="shrink-0 text-zinc-600 group-hover:text-mint" />
                    </a>
                    <div className="relative h-2 flex-1 overflow-hidden rounded-full bg-white/[0.05]" dir="ltr">
                      <div
                    ...
                    <div className="w-20 text-left" dir="ltr">
                      <span className="font-mono text-base font-bold text-zinc-50 tabular">{faNum(c.count)}</span>
          ...
          <div className="flex items-center justify-between border-t hairline bg-black/30 px-6 py-4">
